...
| Resource clearing | Building footprints reject live resources. Workers extract, carry and deliver before the site clears; inaccessible sites wait. Collection and full-storage conservation tests. |
...
| Timed training and technology | Per-building FIFO training, five queued orders, reserved housing, blocked exits, refunds and saves. Nine timed technologies across three prerequisite branches. |
...
| Fleets and flight | Multiple coastal approaches, visible troops, shoreline breaches and departures. Flying enemies arrive directly from the sea. All airborne enemies reject melee; ranged units and ballistas work. Landing restores melee vulnerability. |
| Wall garrisons | Two archers/crossbows per completed wall/gate; reserved positions, physical approach, range bonus, dismounting, fall damage, save compatibility. |
...
| Additional boss abilities | Every pre-seal Nightmare milestone has an extra attack or reinforcement. ArchDemon adds dive/landing, guardian ward and flame cross. Demon Lord adds hurl, eruptions, ring of ruin, five-second rebirth and faster Keep assault. Warnings and inspector explanations provide counterplay. |
| Graphics and customization | Cached overhead roofs, canopies, units, ships, mineral seams, ridges and blended shores; kingdom name plus three Keeps; unit/boss silhouettes and all upgrade atlases inspected. |
...
- 77 passing Node simulation tests, including two independent sets of 100 fixed map seeds.
...
- Six 700-second openings spend real starting resources and use real construction, gathering and training. All reach wave 4 with the Keep intact; both Normal openings complete wave 4.
